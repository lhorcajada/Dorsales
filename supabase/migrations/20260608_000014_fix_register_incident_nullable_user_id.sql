-- Make p_user_id nullable and accept p_user_email as a parameter.
-- Keep dorsal_number nullable for registration-related incidents.
...
begin
  ...
  -- If user_id is provided and email wasn't, try to get it from the profile
